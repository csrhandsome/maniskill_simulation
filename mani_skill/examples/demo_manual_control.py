...
def parse_args():
    ...
    parser.add_argument("-o", "--obs-mode", default="rgb+segmentation", type=str)
    ...
    parser.add_argument("--control-freq", type=int, default=24)
...
def main():
    ...
    if record_dir:
        ...
        env = RecordEpisode(env, record_dir,avoid_overwriting_video=True)
